...
public class Main {
    ...
    /**
     * Sort the people to get vaccinated according to their priority in
     * ascending order.
     *
     * Criteria: - Frontliner has higher priority than non-frontliner - The
     * higher the age of a person, the higher the priority
     */
